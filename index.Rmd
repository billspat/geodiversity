...
```{r site-encompassing domain approach, eval = FALSE}
################################################################################
##### DOMAIN SCALE ##### 
...
**Explanation:** This map uses the center of the smallest circle encompassing all small mammal plots within a site as the "centroid" for that site. I then compared the size of the circle for each site, found the largest one and used that as the standard radius across all sites. An arbitrary 100 km buffer was used to generate the domain-scale circle. 
